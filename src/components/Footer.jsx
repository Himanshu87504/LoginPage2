...
const Footer = () => {
    return (
        <>
            <div className="text-black px-4 sm:px-6 md:px-8 lg:px-16 bg-white/80"
                style={{
            ...
            >
                ...
                <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-4">
                    ...
                    <div className="w-full md:w-1/3 space-y-2">
                        ...
                        <button className="mt-2 bg-pink-500 px-4 py-1 rounded text-sm">
                            Read More
                        </button>
                    </div>
                    ...
                    <div className="w-full md:w-1/4 space-y-2 pl-2">
            ...
            <div className="w-full bg-gray-600  pb-3 text-center text-sm text-white">
                copyright © 2016-2025{" "}
