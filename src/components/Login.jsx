...
//             <div
//                 className={`relative w-[700px] sm:w-[850px] md:w-full min-h-screen flex flex-col bg-cover bg-center transition-all duration-300
//                     }`}
//                 style={{
//                     backgroundImage:
    ...
    return (
        <>
            ...
            >
                ...
                <main className="flex flex-col justify-center items-center px-4 sm:px-6 lg:px-16 mt-10">
                    <div className="flex items-center text-white mb-6">
                        <CiHome className="text-red-500 text-xl sm:text-2xl" />
                        <span className="ml-2 text-sm sm:text-base">
                            MSP/Marriage Bureau Login
                        </span>
                    </div>
                    ...
                    <form
                        className="w-full max-w-md bg-white bg-opacity-80 p-6 sm:p-8 rounded-lg shadow-md border border-pink-400"
                        style={{ backdropFilter: "blur(10px)" }}
                    >
                        <label
